...
export default function ValueScreen({ onGetStarted }: Props) {
      ...
      <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-7 text-center" style={{ paddingBottom: "140px" }}>
        ...
        >
          ...
          <motion.div
            ...
            style={{ background: "radial-gradient(circle, rgba(180,80,255,0.35) 0%, transparent 70%)" }}
            animate={{ scale: [1, 1.25, 1], opacity: [0.4, 0.8, 0.4] }}
            transition={{ duration: 3, repeat: Infinity, ease: "easeInOut" }}
          />

          {/* Clean floating logo */}
          <img src="/logo.webp" className="relative z-10 w-[200px] md:w-[220px] h-auto drop-shadow-[0_8px_20px_rgba(143,0,255,0.5)]" alt="Cutzo Logo" />
        </motion.div>
