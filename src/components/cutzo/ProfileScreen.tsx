...
export default function ProfileScreen({ user, onNavigate, onLogout }: Props) {
  ...
  const sections = [
    ...
    },
    {
      title: "Support & Legal",
      items: [
        { icon: HelpCircle, label: "Connect Us", sub: "Customer support & contact", screen: "help" as Screen },
        { icon: Shield, label: "Privacy Policy", sub: "Data protection & privacy rules", screen: "privacy" as Screen },
        { icon: FileText, label: "Terms & Conditions", sub: "User agreement & refund policy", screen: "terms" as Screen },
        { icon: Info, label: "About CUTZO", sub: "v" + (typeof __APP_VERSION__ !== 'undefined' ? __APP_VERSION__ : '1.0.0'), screen: "about" as Screen },
        { icon: Users, label: "Cutzo Team", sub: "Meet the founders of Cutzo", screen: "team" as Screen },
        { icon: MapPin, label: "How it Works", sub: "Booking guide & features", screen: "howItWorks" as Screen },
      ],
    },
  ];
