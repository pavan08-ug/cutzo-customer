    ...
    <div>
      ...
      {staleWalkIns.length > 0 && (
        <div className="admin-alert admin-alert-danger" style={{ marginBottom: 24 }}>
          <span style={{ color: "var(--admin-danger)", flexShrink: 0, fontSize: 18 }}>⚠️</span>
          <div>
      ...
      <div className="admin-kpi-grid" style={{ gridTemplateColumns: "repeat(4, 1fr)", marginBottom: 28 }}>
        <div className="admin-kpi-card">
          <div className="admin-kpi-icon" style={{ background: "rgba(244,63,94,0.15)" }}>👟</div>
        ...
        <div className="admin-kpi-card">
          <div className="admin-kpi-icon" style={{ background: "rgba(124,58,237,0.15)" }}>📅</div>
        ...
        <div className="admin-kpi-card">
          <div className="admin-kpi-icon" style={{ background: "rgba(245,158,11,0.15)" }}>⚠️</div>
        ...
        <div className="admin-kpi-card">
          <div className="admin-kpi-icon" style={{ background: "rgba(16,185,129,0.15)" }}>🏪</div>
                ...
                (ops?.activeWalkIns || []).map((w: any) => {
                  ...
                  return (
                    <tr key={w._id} style={{ background: isStale ? "rgba(244,63,94,0.05)" : undefined }}>
                      ...
                      <td>
                        {isStale
                          ? <span className="admin-badge admin-badge-danger">⚠️ Stale</span>
