...
function GeographicTab() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      <div className="admin-chart-grid admin-chart-grid-2">
        <div className="admin-card">
          <div className="admin-card-title" style={{ marginBottom: 12 }}>🏙️ Top Cities by Bookings</div>
      ...
      <div className="admin-card" style={{ padding: 0 }}>
        <div style={{ padding: "16px 20px" }} className="admin-card-title">🗺️ City Intelligence Table</div>
