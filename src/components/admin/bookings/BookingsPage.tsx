        ...
        >
          ...
          {booking.cancelReason && (
            <div className="admin-alert admin-alert-danger" style={{ marginBottom: 16 }}>
              <XCircle size={14} style={{ color: "var(--admin-danger)", flexShrink: 0 }} />
...
export default function BookingsPage() {
  ...
  const columns: Column<any>[] = [
    ...
    { key: "otpVerified", label: "OTP", render: (b) => b.otpVerified ? <span className="admin-badge admin-badge-success">✓</span> : <span className="admin-badge admin-badge-muted">✗</span> },
  ];
