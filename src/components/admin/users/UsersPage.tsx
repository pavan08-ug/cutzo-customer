...
import { X, Plus, Minus, Ban, Trash2, Send, ChevronLeft } from "lucide-react";
    ...
    <>
      ...
      >
        ...
        <div className="admin-drawer-body" style={{ overflowY: "auto" }}>
          ...
          {/* Strike Management */}
          <div className="admin-card" style={{ padding: 16 }}>
            <div className="admin-card-title" style={{ marginBottom: 12 }}>⚠️ Strike Management</div>
          ...
          <div className="admin-card" style={{ padding: 16 }}>
            ...
            {isBanned ? (
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                ...
                <button className="admin-btn admin-btn-danger" onClick={handleBan}><Ban size={14} /> Ban User</button>
              </div>
            )}
          </div>
          ...
          <div className="admin-card" style={{ padding: 16 }}>
            ...
            {showNotif && (
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                ...
                <button className="admin-btn admin-btn-primary" onClick={handleSendNotif}><Send size={13} /> Send</button>
              </div>
            )}
          </div>
